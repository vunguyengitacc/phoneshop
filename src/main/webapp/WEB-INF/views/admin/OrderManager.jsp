...
<body class="header-fixed sidebar-fixed sidebar-dark header-light"
			...
			<div id="sidebar" class="sidebar sidebar-with-footer">
				...
				<div class="" data-simplebar style="height: 100%;">
					...
					<ul class="nav sidebar-inner" id="sidebar-menu">
						...
						<li class="has-sub "><a class="sidenav-item-link"
							href="/Web/admin/danh-sach-hoa-don"  style="color: white; font-size: 1.005rem" aria-expanded="false"
								...
								<div class="card card-default">
									...
									<div class="card-body">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<select class="form-control" id="selectItem">
													<option>Xem</option>
													<c:forEach var="item"
														items="${billDetail.productHasColorHasBills }">
														<option>${item.productHasColor.product.name }-${item.productHasColor.color.name }
										...
										<div class="form-group">
											...
											<c:choose>
												<c:when test="${billDetail.promotion!=null }">

													<input type="text" class="form-control" id="promoCode"
														value="${billDetail.promotion.id }" readonly="readonly">
												</c:when>
												<c:otherwise>
													<div class="input-group">
														<input type="text" class="form-control" id="promoCode"
															value="Không dùng" readonly="readonly">
												</c:otherwise>
											</c:choose>
										</div>
									</div>
	...
	<form action="/Web/admin/danh-sach-hoa-don" id="combackTrick"></form>
	...
	<script type="text/javascript">
		...
		function completeSubmit(){
			$.ajax({
				url: "/Web/admin/api/hoa-don?"+$("#billDetailForm").serialize(),
				type: 'PUT',
				success:(response)=>{
