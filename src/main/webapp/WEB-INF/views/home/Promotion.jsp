			...
			<div class="container">
				<nav class="nav-menu mobile-menu">
					<ul>
						...
						<li class="active"><a
							href="/Web/trang-chu/ma-giam-gia?trang=1&sapXep=1">KHUYẾN MÃI</a></li>
					</ul>
				</nav>
												...
												<div class="info">
													...
													<c:choose>
														<c:when test="${item.type == 1 }">
															<p class="desc">Dùng theo user</p>
														</c:when>
														<c:when test="${item.type == 2 }">
															<p class="desc">Dùng theo ngày</p>
														</c:when>
														<c:when test="${item.type == 3 }">
															<p class="desc">Dùng theo tuần</p>
														</c:when>
														<c:otherwise>
															<p class="desc">Dùng theo tháng</p>
														</c:otherwise>
													</c:choose>
													<ul>
														<li style="width: 65%;"><span>GIẢM: </span> <span
															style="font-size: 2rem;">${item.value }%</span></li>
														<li style="width: 35%;"
															onclick="addPromotionHandler('${item.id}')"><span
															style="font-size: 1.5rem;">DÙNG NGAY</span></li>
													</ul>
												</div></li>
